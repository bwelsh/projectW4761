...
####Result files
best_level_all.png - This plot is created by the cgen_project.py file. It plots the ROC space for validation and test data for the best model for the best levels for each dataset.
...
3. Run cgen_project.py. This will complete the analysis of the data and create the plots in this repository. It runs in under 2 minutes on a standard laptop, due to the time-consuming parameter selection being done in the step above and saved to files.
